...
export const actionCreators = {
    addOrderItem: (orderItemDate, remark, deliverBy, deliverDate, shop, userId) => async (dispatch, getState) => {
        dispatch({ type: ADD_REQUEST });

        return new Promise((resolve, reject) => {
            orderItemService.addOrderItem(orderItemDate, remark, deliverBy, deliverDate, shop, userId)
                .then(
                    item => {
